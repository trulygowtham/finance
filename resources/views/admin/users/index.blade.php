        ...
        <div class="row-fluid">
            <div class="span12 widget">
                <div class="widget-header">
                    ...
                    <div class="toolbar">
                        <div class="btn-group">
                            <<a href="{{route('admin.users.add')}}"  class="btn" title="New User">
                                New
                            </a>
                        </div>
                    </div>
...
<!--                                <td class="action-col">
                                ...
                                <td><?php
                                    ...
                                    $buttons.=' <a class="btn btn-small btn-primary" href="' . route("admin.users.view", base64_encode($page->id)) . '"  >View</a>';
                                    $buttons.='<a class="btn btn-small btn-info" href="' . route("admin.users.edit", base64_encode($page->id)) . '"  >Edit</a>';

                                    $buttons.='<a class="btn btn-small btn-danger" href="' . route("admin.users.delete", base64_encode($page->id)) . '"   onclick="return confirm(' . "'Are you sure to delete this user?'" . ')" >';
                                    $buttons.='Delete</a>';
                                    $buttons.='</div>';
                                    echo $buttons;
                                    ?>  </td> 
