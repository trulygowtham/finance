                    ...
                    <div class="widget-content form-container">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="name" name="name" class="span12" value="{{ old('name', @$categories->name) }}"/>
                                    @if ($errors->has('name'))
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea id="description" name="description" class="span12" value="" >{{ old('description', @$categories->description) }}</textarea>
