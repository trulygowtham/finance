<title>Check List - New Department</title>
                            ...
                            <div class="controls">
                                <select id="user_id" multiple name="user_id[]" class="select2-select-00 span12" multiple="" size="5" data-placeholder="Select a user">
                                    ...
                                    <?php foreach ($users as $key => $userRow) { ?>
                                        <option value="<?php echo $userRow['id']; ?>" <?php echo (old('group_id', @$users->group_id) == $userRow['id']) ? 'SELECTED' : ''; ?>><?php echo $userRow['username'] . '(' . $userRow['name'] . ')'; ?></option>
                                    <?php } ?>
                                </select>
