<title>Check List - Questions</title>
...
<!--                                <td class="action-col">
                                ...
                                <td><?php
                                    ...
                                    $buttons.=' <a class="btn btn-small btn-primary" href="' . route("questions.view", base64_encode($page->id)) . '"  >View</a>';
                                    $buttons.='<a class="btn btn-small btn-info" href="' . route("questions.edit", base64_encode($page->id)) . '"  >Edit</a>';

                                    $buttons.='<a class="btn btn-small btn-danger" href="' . route("questions.delete", base64_encode($page->id)) . '"   onclick="return confirm(' . "'Are you sure to delete this question?'" . ')" >';
                                    $buttons.='Delete</a>';
                                    $buttons.='</div>';
                                    echo $buttons;
                                    ?>  </td> 
