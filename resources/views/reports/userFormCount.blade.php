<title>Check List - Reports - User Form Count</title>
<section id="main" class="clearfix">
    <div id="main-header" class="page-header">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="#">User Form Count</a>
            </li>
        </ul>

        <h1 id="main-heading">
            Reports :: User Form Count <span>    </span>
        </h1>
    </div>
                    ...
                    <table id="users-table" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{ $page->pending_cnt }}   </td> 
                                <td>{{ $page->completed_cnt }}</td>
                                <td>{{ $page->cancelled_cnt }}</td>
